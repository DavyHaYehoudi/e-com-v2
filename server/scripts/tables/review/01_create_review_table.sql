CREATE TABLE IF NOT EXISTS review (
    ...
    customer_id INT NULL,                         -- Référence au client auteur du commentaire
    order_id INT NULL,                            -- Référence à la commande en question
    product_id INT NULL,                          -- Référence au produit pour lequel le commentaire est laissé
    review_text VARCHAR(500) NOT NULL,                        -- Texte du commentaire
