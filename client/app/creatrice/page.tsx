...
import profil from "@/components/pages/creatrice/images/profil.jpg"
          ...
          <div className="animated-container">
            <section className="story-section">
              ...
              <p>
                ...
                évidence : imaginer et créer un bijou qui vous ressemble en y
                intégrant l&apos;ancienne Tradition du{" "}
                <i>
            ...
            <section className="inspiration-section">
              ...
              <p>
                ...
                dans l&apos;herbe fraîche de mon jardin, en observant ce que la nature
                veut bien me montrer et en faisant confiance à mon intuition.
                ...
                travers mes créations se dégage une sensation de douceur, d&apos;amour
                et de simplicité en y mettant tout mon savoir-faire mais aussi de
                belles intentions.
            ...
            <Image
              ...
              <p>
                ...
                l&apos;innocence et l&apos;impétuosité, j&apos;ai souhaité qu&apos;ils fassent partie
                intégrante de ma petite entreprise.
            ...
            <section className="engagements-section">
              ...
              <p>
                ...
                <br /> J&apos;aime travailler avec les bijoux constitués de Goldfilled,
                un matériau consistant à appliquer une épaisse couche d&apos;or.
                <br /> Sa particularité ? Nous sommes sur de l&apos;or recyclé ce qui
                est une très belle alternative.
                <br /> Au final, le rendu est presque identique à celui de l&apos;or !
                <br /> Les écrins sont fabriqués en Europe, les boîtes d&apos;envois
                dans les Hauts-de-France, les deux conçus avec du carton certifié
                FSC® et de la colle à base d&apos;eau.
              </p>
            </section>
  
            <div className="bottom-section">
              <p>
                Je souhaite du fond du cœur qu&apos;en portant sur vous les créations
                de l&apos;Atelier Noralya, un sourire se liera sur votre merveilleux
                visage.
              </p>
            </div>
          </div>
